    ...
    public class ShopManager : MonoBehaviour
    {
        ...
        private bool CreateShopItem(string cardId)
        {
            ...
            if (buttonRect != null)
            {
                ...
                Debug.Log($"[ShopManager] 按钮anchor已设置为顶部中心: Min(0.5,1) Max(0.5,1)");
            }
        ...
        private void PositionButtonBelowItem(GameObject buttonInstance, GameObject itemInstance, float gap)
        {
            ...
            {
                Debug.LogWarning("[ShopManager] 无法设置按钮位置：缺少RectTransform组件");
                return;
            }
            ...
            Debug.Log($"[ShopManager] 按钮位置已设置: 物品顶部={itemTop:F1}, 物品底部={itemBottom:F1}, 按钮Y={buttonY:F1}, 间距={gap}");
        }
    }
}
